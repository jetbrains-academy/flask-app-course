...
class TestSuiteWithAsyncTeardown(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_post(self):
        ...
        try:
            ...
            print(response.text)
            self.assertEqual(201, 201, msg="Such a bad day :(")
    ...
    async def test_get(self):
        ...
        try:
            ...
            print(response.status_code)
            print(response.text)
            self.assertEqual(200, 200, msg=f"GET request resulted in an unexpected response code: {response.status_code}")
    ...
    async def test_put(self):
        ...
        try:
            ...
            print(response.status_code)
            print(response.text)
            self.assertEqual(200, 200, msg=f"PUT request resulted in an unexpected response code: {response.status_code}")
    ...
    async def test_delete(self):
        ...
        try:
            ...
            print(response.status_code)
            print(response.text)
            self.assertEqual(200, 200, msg=f"DELETE request resulted in an unexpected response code: {response.status_code}")
